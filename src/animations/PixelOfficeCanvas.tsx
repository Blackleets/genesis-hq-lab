...
import AgentWorkOverlay from '@agents/AgentWorkOverlay';
...
} from '@animations/pixelCanvasRenderer';
import { createPixelLifeRuntime, stepPixelLifeLoop } from '@animations/pixelLifeLoop';
...
export default function PixelOfficeCanvas({ scale, onAgentHover, onRoomClick }: Props) {
  ...
  }, [agents, firedAgents, tasks, events, lang, selectedAgent?.id, devMode, liveTrades, hoveredAgentId]);
