...
import { actions, useTaskById, useTasks } from '../state/genesisStore';
  ...
  return (
    <aside className="absolute top-0 right-0 bottom-0 w-[320px] z-40 bg-carbon-200 border-l border-trim shadow-2xl flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 space-y-4">
        ...
        {currentTask ? (
          <section className="border border-trim bg-carbon-300 p-3 font-mono text-[11px] space-y-1.5">
        ...
        {((agent.tradeCount ?? 0) > 0 || (agent.totalPnL ?? 0) !== 0) && (
          <section>
            ...
            <div className="grid grid-cols-3 gap-2">
              <div className="border border-trim bg-carbon-300 px-2 py-2">
