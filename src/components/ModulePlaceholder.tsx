...
import { MODULE_BY_ID, type ModuleId, stateTKey } from '../data/moduleRegistry';
  ...
  return (
    <main className="flex-1 min-w-0 min-h-0 overflow-y-auto px-8 py-8 bg-carbon-300">
      <div className="max-w-3xl mx-auto">
        ...
        <section className="border border-trim bg-carbon-200 p-5 mb-4">
        ...
        <section className="border border-trim bg-carbon-200 p-5 mb-4">
          <div className="font-mono text-[10px] uppercase tracking-wider text-zinc-500 mb-3">
