            ...
            {meta.configFields.map((field) => (
              <div key={field.key}>
                ...
                <input
                  ...
                  className="w-full bg-carbon-300 border border-trim font-mono text-[11px] text-zinc-100 px-3 py-2 focus:outline-none focus:border-zinc-500 placeholder:text-zinc-700"
                />
              </div>
            ))}
          </div>
