  ...
  return (
    <div className="border-b border-zinc-800 bg-[#0b0e11]">
      <div className="flex items-center gap-2 px-3 pt-2.5 pb-1.5 flex-wrap">
        ...
        <div className="flex gap-0.5 ml-auto rounded bg-[#11151c] p-0.5">
          {intervals.map((iv) => (
            <button
              key={iv}
              type="button"
      ...
      <div className="flex items-end gap-4 px-3 pb-2.5 flex-wrap">
        <div className="flex items-baseline gap-2">
          <span className="font-mono text-[12px] font-bold text-zinc-400">
            {symbol}<span className="text-zinc-600">/USDT</span>
          </span>
          <span
            className={`font-mono text-[22px] font-bold tabular-nums leading-none rounded px-1 -mx-1 transition-colors duration-300 ${
              flash === 'up'
      ...
      <div className="flex items-center gap-4 px-3 pb-1.5 text-[9px] font-mono border-t border-zinc-800/50 pt-1">
        <button
          type="button"
