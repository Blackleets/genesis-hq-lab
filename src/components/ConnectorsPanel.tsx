...
import { useConnectors } from '../state/genesisStore';
import { PLATFORM_METADATA } from '../data/platformCapabilities';
      ...
      <section className="border border-trim bg-carbon-200">
        ...
        <div className="px-4 py-3 space-y-3">
          ...
          <div>
            ...
            <div className="bg-carbon-300 border border-trim px-3 py-2 font-mono text-[11px] text-emerald-300">
              npm run mcp
            </div>
          </div>
          <div>
            ...
            <pre className="bg-carbon-300 border border-trim px-3 py-2 font-mono text-[10px] text-zinc-300 overflow-x-auto whitespace-pre-wrap">
              {mcpConfigSnippet}
            </pre>
          </div>
        </div>
