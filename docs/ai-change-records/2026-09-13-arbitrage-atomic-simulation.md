...
- Verification: GitHub Actions `MEV shadow checks` passed module syntax, focused MEV shadow tests, and production build on commit `b0a446120620a1b41c7b961eb02275449e7c653e`.
