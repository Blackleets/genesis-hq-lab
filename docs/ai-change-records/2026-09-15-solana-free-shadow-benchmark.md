...
- Remaining integration: the Solana transaction-instruction builder must supply the complete writable-account list through `writableAccountResolver`. Until then, the radar intentionally fails closed.
