...
function isNoDirectRoute(errors: string[]) { return errors.length > 0 && errors.every((error) => /no routes found|route not found|could not find any route/i.test(error)); }
